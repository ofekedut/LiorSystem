CREATE_SCHEMA_QUERIES = [
    # Enum types
    """DO $$ BEGIN CREATE TYPE document_type AS ENUM ('one-time','updatable','recurring'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE document_category AS ENUM ('identification','financial','property','employment','tax'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE required_for AS ENUM ('employees','self-employed','business-owners','all'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE validation_operator AS ENUM ('equals','not_equals','greater_than','less_than','between','contains','starts_with','ends_with','before','after'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE case_status AS ENUM ('active', 'inactive', 'pending'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE person_role AS ENUM ('primary', 'cosigner', 'guarantor'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE person_gender AS ENUM ('male', 'female'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE document_status AS ENUM ('pending', 'approved', 'rejected'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE document_processing_status AS ENUM ('processed', 'pending', 'error', 'userActionRequired'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
    """DO $$ BEGIN CREATE TYPE loan_status AS ENUM ('active', 'closed', 'defaulted'); EXCEPTION WHEN duplicate_object THEN null; END$$;""",
