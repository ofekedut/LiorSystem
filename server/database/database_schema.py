...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_person_assets_timestamp') THEN
...
""",
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_person_employment_history_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_person_income_sources_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_person_bank_accounts_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_person_credit_cards_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_person_loans_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_document_entity_relations_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_case_loans_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_case_companies_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_case_desired_products_timestamp') THEN
    ...
    DO $$ 
    BEGIN
        IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_processing_step_results_timestamp') THEN
